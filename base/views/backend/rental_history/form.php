...
<div class="note note-info">
    <p>Isikan data Rental History pada form berikut dengan lengkap dan benar</p>
</div>
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-sharp">                        
                    <span class="caption-subject bold uppercase"> Data Rental History</span>
                </div>
                <div class="actions">                    
                    <a href="<?php echo base_url('rental_history/index/'.$site->id1); ?>" class="btn btn-circle btn-primary btn-sm"><i class="fa fa-long-arrow-left"></i> Back</a>
                </div>
			</div>
                ...
                <form action="<?php echo base_url($url); ?>" method="post" id="form" class="form-horizontal detailnya" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <a href="<?php echo base_url('rental_history/index/'.$site->id1); ?>" class="btn default"><i class="fa fa-long-arrow-left"></i> Kembali</a>
                        </div>
                    </div>
                </form>
