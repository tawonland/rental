...
<div class="note note-info">
    <p>Isikan data Invoice pada form berikut dengan lengkap dan benar</p>
</div>
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-sharp">                        
                    <span class="caption-subject bold uppercase"> Data Invoice</span>
                </div>
                <div class="actions">                    
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="tagihan_ke" value="<?php echo $data['tagihan_ke']; ?>" class="form-control aneh" required placeholder="Tagihan Ke">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="no_invoice" value="<?php echo $data['no_invoice']; ?>" class="form-control aneh" required placeholder="No. Invoice">
                                </div>
                            </div>
                        </div>
                    </div>
