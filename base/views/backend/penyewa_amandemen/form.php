...
<div class="note note-info">
    <p>Isikan data Penyewa Amandemen pada form berikut dengan lengkap dan benar</p>
</div>
                ...
                <form action="<?php echo base_url($url); ?>" method="post" id="form" class="form-horizontal detailnya" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Tanggal" name="tgl" required="" value="<?php echo ($data['tgl'] == '' ? date('Y-m-d') : $data['tgl']); ?>" id="datepicker2">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="jenisperubahan" class="form-control">
                                    <?php
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <a href="<?php echo base_url('penyewa_amandemen/index/'.$site->id.'/'.$site->idx); ?>" class="btn default"><i class="fa fa-long-arrow-left"></i> Kembali</a>
                        </div>
                    </div>
                </form>
