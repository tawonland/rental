	...
	<div class="col-lg-12 col-xs-12 col-sm-12">
		<div class="portlet light bordered">
			<div class="portlet-title">
                ...
                <div class="actions">                    
                    <a href="<?php echo base_url('penyewa_file/add/'.$site->id.'/'.$site->idx); ?>" class="btn btn-circle btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
...
var t = $('#mytable').DataTable({
    ...
    "columns": [
        ...
        {"data": "tgl_upload", "class": "text-center"}, 
        {"data": "deskripsi", "class": "text-left"}, 
        {"data": "tgl_receive", "class": "text-center"}, 
        {"data": "namafile", "class": "text-center"}, 
