...
var t = $('#mytable').DataTable({
    ...
    "columns": [
        ...
        {"data": "msubcon", "class": "text-left"}, 
        {"data": "material", "class": "text-left"}, 
        {"data": "termasukppn", "class": "text-center"}, 
        {"data": "sub_total", "class": "text-right"}, 
        {"data": "tglselesai", "class": "text-center"},
