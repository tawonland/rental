	...
	<div class="col-lg-12 col-xs-12 col-sm-12">
		<div class="portlet light bordered">
			<div class="portlet-title">
                ...
                <div class="actions">                    
                    <a href="<?php echo base_url('penyewa_amandemen/add/'.$site->id.'/'.$site->idx); ?>" class="btn btn-circle btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
...
var t = $('#mytable').DataTable({
    ...
    "columns": [
        ...
        {"data": "nospk", "class": "text-left"}, 
        {"data": "jenisperubahan", "class": "text-center"}, 
